...
class PredictionPipeline:
    ...
    def get_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            self.gcloud.sync_folder_from_gcloud(self.bucket_name,
                                                self.model_name,
                                                self.model_path)
    ...
    def predict(self, best_model_path, text):
        """load text and return predictions"""
        logging.info("Entering the predict method of PredictionPipeline class")
        try:
    ...
    def run_pipeline(self, text):
        ...
        try:
            ...
            logging.info(
                "Exited the run_pipeline method of PredictionPipeline")
